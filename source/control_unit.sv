...
//           next_rx_state = IDLE;
//         end
//         else if (start_bit_det) begin
//           next_rx_state = UART_BUSY;
//         end
//       end
//       UART_BUSY: begin
//         if (rx_ready && ~start_bit_det) begin
//           next_rx_state = UART_IDLE;
//         end
//       end
//       SPI_IDLE: begin
//         if (mode_select != 2'b01) begin
...
//         end
//         else if (~(&cs_n)) begin
//           next_rx_state = SPI_BUSY;
//         end
//       end
//       SPI_BUSY: begin
//         if (rx_ready && (&cs_n)) begin
//           next_rx_state = SPI_IDLE;
//         end
//       end
//     endcase
//   end
...
//       IDLE: begin
//         if (mode_select == 2'b00) begin
//           next_tx_state = UART_IDLE;
//         end
//         else if (mode_select == 2'b01) begin
//           next_tx_state = SPI_IDLE;
//         end
//       end
//       UART_IDLE: begin
//         if (mode_select != 2'b00) begin
//           next_tx_state = IDLE;
//         end
//         else if (buffer_occupancy > 8'd0 && ~tx_busy) begin
//           next_tx_state = UART_BUSY;
//           send = 1'b1;
//         end
//       end
//       UART_BUSY: begin
...
//   //         next_rx_state = SPI_IDLE;
//   //       end else if (mode_select == 2'b10) begin
//   //         next_rx_state = I2C_IDLE;
//   //       end
//   //     end
//   //     UART_IDLE: begin
//   //       if (start_bit_det) begin
//   //         next_rx_state = UART_START;
//   //       end
//   //     end
//   //     UART_START: begin
//   //       next_rx_state = UART_DATA;
//   //       next_rx_bit_cnt = 3'd0;
//   //     end
//   //     UART_DATA: begin
        
//   //     end
//   //     // Additional state transitions for UART, SPI, and I2C would go here...
